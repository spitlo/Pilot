...
export default function Mixer(pilot) {
    ...
    this.install = function (host) {
        ...
        // AM
        this.channels[0] = new ChannelInterface(
            pilot,
            0,
            new Tone.AMSynth({
                harmonicity: 1.25,
        ...
        this.channels[1] = new ChannelInterface(
            pilot,
            1,
            new Tone.AMSynth({
                harmonicity: 1.5,
        ...
        this.channels[2] = new ChannelInterface(
            pilot,
            2,
            new Tone.AMSynth({
                harmonicity: 1.75,
        ...
        this.channels[3] = new ChannelInterface(
            pilot,
            3,
            new Tone.AMSynth({
                harmonicity: 2,
        ...
        // AM
        this.channels[4] = new ChannelInterface(
            pilot,
            4,
            new Tone.AMSynth({
                harmonicity: 1.25,
        ...
        this.channels[5] = new ChannelInterface(
            pilot,
            5,
            new Tone.AMSynth({
                harmonicity: 1.5,
        ...
        this.channels[6] = new ChannelInterface(
            pilot,
            6,
            new Tone.FMSynth({
                harmonicity: 1.75,
        ...
        this.channels[7] = new ChannelInterface(
            pilot,
            7,
            new Tone.FMSynth({
                harmonicity: 2,
        ...
        // FM
        this.channels[8] = new ChannelInterface(
            pilot,
            8,
            new Tone.FMSynth({
                harmonicity: 0.5,
        ...
        this.channels[9] = new ChannelInterface(
            pilot,
            9,
            new Tone.FMSynth({
                harmonicity: 2.5,
        ...
        this.channels[10] = new ChannelInterface(
            pilot,
            10,
            new Tone.MonoSynth({
                volume: -20,
        ...
        this.channels[11] = new ChannelInterface(
            pilot,
            11,
            new Tone.MonoSynth({ volume: -20, oscillator: { type: "sine4" } })
        );
        // Membrane
        this.channels[12] = new ChannelInterface(
            pilot,
            12,
            new Tone.MembraneSynth({ octaves: 5, oscillator: { type: "sine" } })
        );
        this.channels[13] = new ChannelInterface(
            pilot,
            13,
        ...
        this.channels[14] = new ChannelInterface(
            pilot,
            14,
            new Tone.MembraneSynth({
                octaves: 15,
        ...
        this.channels[15] = new ChannelInterface(
            pilot,
            15,
            new Tone.MembraneSynth({
                octaves: 20,
        ...
        this.effects.distortion = new EffectInterface(
            pilot,
            "dis",
            new Tone.Distortion(0.05)
        );
        this.effects.autowah = new EffectInterface(
            pilot,
            "wah",
            new Tone.AutoWah(100, 6, 0)
        );
        this.effects.chebyshev = new EffectInterface(
            pilot,
            "che",
            new Tone.Chebyshev(50)
        );
        // II
        this.effects.feedback = new EffectInterface(
            pilot,
            "fee",
            new Tone.FeedbackDelay(0)
        );
        this.effects.delay = new EffectInterface(
            pilot,
            "del",
            new Tone.PingPongDelay("4n", 0.2)
        );
        this.effects.tremolo = new EffectInterface(
            pilot,
            "tre",
            new Tone.Tremolo()
        );
        this.effects.reverb = new EffectInterface(
            pilot,
            "rev",
            new Tone.JCReverb(0)
        );
        // III
        this.effects.phaser = new EffectInterface(
            pilot,
            "pha",
            new Tone.Phaser(0.5, 3, 350)
        );
        this.effects.vibrato = new EffectInterface(
            pilot,
            "vib",
            new Tone.Vibrato()
        );
        this.effects.chorus = new EffectInterface(
            pilot,
            "cho",
            new Tone.Chorus(4, 2.5, 0.5)
        );
        this.effects.widener = new EffectInterface(
            pilot,
            "ste",
            new Tone.StereoWidener(0.5, 3, 350)
        );
        // Mastering
        this.effects.equalizer = new EffectInterface(
            pilot,
            "equ",
            new Tone.EQ3(5, 0, 5)
        );
        this.effects.compressor = new EffectInterface(
            pilot,
            "com",
            new Tone.Compressor(-6, 4)
        );
        this.effects.volume = new EffectInterface(
            pilot,
            "vol",
            new Tone.Volume(6)
        );
        this.effects.limiter = new EffectInterface(
            pilot,
            "lim",
            new Tone.Limiter(-2)
        );
    ...
    this.reset = function () {
        ...
        this.run(
            "0OSC8ISI;1OSC8RSW;2OSC8WTR;3OSC8QSQ;4OSC4I8Q;5OSC4R8W;6OSCTR8R;7OSCTR8I;8OSCTR4W;9OSCTR8R;AOSC4W--;BOSC4I--;COSCSI--;DOSCSW--;EOSCTR--;FOSCSQ--"
        );
